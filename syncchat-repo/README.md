...
**Peer-to-peer content model:** chat messages, voice messages and verify
clips travel directly between the two devices over an encrypted WebRTC data
channel — the server is a content-blind matchmaker/signaling relay and never
stores conversation content. See `random-chat/P2P_ARCHITECTURE.md`.
